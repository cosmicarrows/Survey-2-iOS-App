...
#import "ResultsTwoViewController.h"
#import "AppDelegate.h"

@interface ResultsTwoViewController ()

@end

@implementation ResultsTwoViewController

@synthesize questionTwoTableView = _questionTwoTableView;
...
- (void)viewDidLoad
{
    ...
    // Survey answers for question 2 returns an array of strings
    
    for (int i = 0; i < [[delegate surveys] count]; i++) {
        
        [self.selections addObject:[[[delegate surveys] objectAtIndex:i] objectAtIndex:1]];
    }
