...
#import "ResultsThreeViewController.h"
#import "AppDelegate.h"

@interface ResultsThreeViewController ()

@end

@implementation ResultsThreeViewController
@synthesize questionThreeTableView = _questionThreeTableView;
...
- (void)viewDidLoad
{
    ...
    // Survey answers for question 3 returns an array of strings
    
    // The answers are at index 2
    
    for (int i = 0; i < [[delegate surveys] count]; i++) {
        
        [self.selections addObject:[[[delegate surveys] objectAtIndex:i] objectAtIndex:2]];
    }
