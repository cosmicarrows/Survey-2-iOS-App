...
#import "ResultsSevenViewController.h"
#import "AppDelegate.h"

@interface ResultsSevenViewController ()

@end

@implementation ResultsSevenViewController

@synthesize questionSevenTableView = _questionSevenTableView;
...
- (void)viewDidLoad
{
    ...
    // Survey answers for question 7 returns an array of strings
    
    // The answers are at index 6
    
    for (int i = 0; i < [[delegate surveys] count]; i++) {
        
        [self.selections addObject:[[[delegate surveys] objectAtIndex:i] objectAtIndex:6]];
    }
