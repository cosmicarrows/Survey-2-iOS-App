...
#import "ResultsFiveViewController.h"
#import "AppDelegate.h"

@interface ResultsFiveViewController ()

@end

@implementation ResultsFiveViewController
@synthesize questionFiveTableView = _questionFiveTableView;
...
- (void)viewDidLoad
{
    ...
    // Survey answers for question 5 returns an array of strings
    
    // The answers are at index 4
    
    for (int i = 0; i < [[delegate surveys] count]; i++) {
        
        [self.selections addObject:[[[delegate surveys] objectAtIndex:i] objectAtIndex:4]];
    }
