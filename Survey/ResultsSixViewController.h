...
@interface ResultsSixViewController : UIViewController <UITableViewDelegate, UITableViewDataSource>
{
    int totalCount;
}

@property (strong, nonatomic) IBOutlet UITableView *questionSixTableView;
